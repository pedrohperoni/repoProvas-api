...
export function login(UserLoginRequest) {
    return __awaiter(this, void 0, void 0, function () {
        var email, password, user, secretKey, config, token, loginData;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    user = _a.sent();
                    return [4 /*yield*/, checkPassword(password, user.password)];
                case 2:
                    _a.sent();
                    secretKey = process.env.JWT_SECRET;
                    config = { expiresIn: 60 * 60 * 24 * 30 };
                    token = jwt.sign(user, secretKey, config);
                    return [4 /*yield*/, sessionsRepository.create(user.id, token)];
                case 3:
                    _a.sent();
                    loginData = {
                        token: token,
...
function checkPassword(requestPassword, userPassword) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
