...
export default function tokenValidationMiddleware(req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        var authorization, token, userDataBySession, secretKey, user;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (!token)
                        throw { type: "bad_request", message: "Token not defined" };
                    return [4 /*yield*/, sessionsRepository.findSessionByToken(token)];
                case 1:
                    userDataBySession = _a.sent();
                    if (!userDataBySession)
                        throw { type: "unauthorized", message: "Session not found" };
